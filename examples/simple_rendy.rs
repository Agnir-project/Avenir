...
lazy_static::lazy_static! {
    static ref RENDER_VERTEX: SpirvShader = SourceShaderInfo::new(
        ...
        concat!(env!("CARGO_MANIFEST_DIR"), "/examples/render.vert").into(),
        ShaderKind::Vertex,
        SourceLanguage::GLSL,
        "main",
    ).precompile().unwrap();
    ...
    static ref RENDER_FRAGMENT: SpirvShader = SourceShaderInfo::new(
        ...
        concat!(env!("CARGO_MANIFEST_DIR"), "/examples/render.frag").into(),
        ShaderKind::Fragment,
        SourceLanguage::GLSL,
        "main",
    ).precompile().unwrap();
    ...
    static ref BOUNCE_COMPUTE: SpirvShader = SourceShaderInfo::new(
        ...
        concat!(env!("CARGO_MANIFEST_DIR"), "/examples/bounce.comp").into(),
        ShaderKind::Compute,
        SourceLanguage::GLSL,
        "main",
    ).precompile().unwrap();
                ...
                *control_flow = ControlFlow::Poll;
                match event {
                    ...
                    Event::MainEventsCleared => {
                        ...
                        if elapsed >= std::time::Duration::new(20, 0) {
